...
export const RESUME_DATA = {
  ...
  about:
    "A 23 Year old Full Stack Senior Software Engineer focused on building scalable products with passion and a knack for translating complex challenges into elegant solutions",
  summary:
